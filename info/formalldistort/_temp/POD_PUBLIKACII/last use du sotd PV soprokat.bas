...
SOPROKAT = SOPROKAT +(C_PROT* dik8*fi_step *PI/180 * R_win * s_d*(o_phi_kat-na100)*fi_step*sinus(na100))   + m_prot_tek * (o_omega_prot * R_kat_tek(0))^2/(2*2*PI*R_kat_tek(0)) *sinus(na100)
