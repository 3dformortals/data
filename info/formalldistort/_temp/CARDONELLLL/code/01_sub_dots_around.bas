...
REM k - номер колеса
REM i,j - координаты точки вокруг которой идет обход
REM X,Y,Z - координаты точки ko центр масс колеса
REM A,B,C - составляющие направляющего вектора прямой
REM R - радиус шины [mm]
REM D_P - желаемая дистанция для плоскости [mm]
REM dik8 - ширина шины [mm]
