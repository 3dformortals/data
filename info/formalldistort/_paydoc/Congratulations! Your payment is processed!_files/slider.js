...
function slider (a_init, a_tpl) {
	...
	document.write(
			'<div onmousedown="return f_sliderMouseDown(' + this.n_id + ')" style="width:' + this.n_controlWidth + 'px;height:' + this.n_controlHeight + 'px;border:0; background:url(' + this.s_imgControl + ') center no-repeat; margin-left:-6px" id="sl' + this.n_id + 'base">' +
			'<div class="sliderGlow" style="background:url(' + this.s_imgGlow + ') 6px center no-repeat;width:' + this.n_pathLeft + 'px;height:' + this.n_controlHeight + 'px;border:0;" id="sl' + this.n_id + 'glow">' +
