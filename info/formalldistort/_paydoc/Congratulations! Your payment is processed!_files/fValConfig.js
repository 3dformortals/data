var validation_needed  = true; /* =false for buttons like Cancel */

function setValidation() { validation_needed = true; }

function clearValidation() { validation_needed = false; }
...
function fValConfig()
{
	...
	this.errorClass = 'fieldError'; //errHilite

	//	If you wish fValidate to use only single classNames for errors
	this.useSingleClassNames = true; // or true
	...
	this.boxError = 'webgate__errors_placeholder';
