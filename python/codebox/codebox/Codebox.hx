...
class Codebox {
	...
	public static inline function getMatches(ereg:EReg, input:String, index:Int = 0):Array<String> {
		var matches = [];
	...
	public static inline function opposite(t:String):String {
		var num = "0123456789";
	...
	public static inline function mix(t:String, mode:String = "abc") {
		var x = t;
		switch (mode) {
			default:
				{
