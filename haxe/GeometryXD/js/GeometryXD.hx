...
class GeometryXD{
    ...
    public function positive_inside_I(a:Array<Int>):Bool{
        for (i in a){ if (i > 0){ return true; } }
        return false;
    }
    public function zero_inside_I(a:Array<Int>):Bool{
        for (i in a){ if (i == 0){ return true; } }
        return false;
    }
    public function negative_inside_I(a:Array<Int>):Bool{
        for (i in a){ if (i < 0){ return true; } }
        return false;
    }
    
    public function positive_inside_F(a:Array<Float>):Bool{
        for (i in a){ if (i > 0){ return true; } }
        return false;
    }
    public function zero_inside_F(a:Array<Float>):Bool{
        for (i in a){ if (i == 0){ return true; } }
        return false;
    }
    public function negative_inside_F(a:Array<Float>):Bool{
        for (i in a){ if (i < 0){ return true; } }
        return false;
    }
    
    public function sum_I(a:Array<Int>):Int{
        var rez:Int = 0;
        for (i in 0...a.length){ rez += i;}
        return rez;
    }
    public function sum_F(a:Array<Float>):Float{
        var rez:Float = 0;
        for (i in 0...a.length){ rez += i;}
        return rez;
    }
    public function diff_I(a:Array<Int>):Int{
        var rez:Int = a[0];
        for (i in 1...a.length){ rez -= i;}
        return rez;
    }
    public function diff_F(a:Array<Float>):Float{
        var rez:Float = a[0];
        for (i in 1...a.length){ rez -= i;}
        return rez;
    }
    public function middle_F(a:Array<Float>):Float{
        return sum_F(a) / a.length;
    }
    public function multiply_FperF(a:Array<Float>, n:Float):Array<Float>{
        return [for (i in 0...a.length) a[i] * n];
    }
    public function multiply_I(a:Array<Int>):Int{
        var rez:Int = a[0];
        for (i in 1...a.length){ rez *= i;}
        return rez;
    }
    public function multiply_F(a:Array<Float>):Float{
        var rez:Float = a[0];
        for (i in 1...a.length){ rez *= i;}
        return rez;
    }
    public function minus_I(a:Array<Int>):Array<Int>{
        return [for (i in 0...a.length) -a[i]];
    }
    public function minus_F(a:Array<Float>):Array<Float>{
        return [for (i in 0...a.length) -a[i]];
    }
    ...
    public function multiply_xFperF(a:Array<Array<Float>>, n:Float):Array<Array<Float>>{
    ...
    public function multisum_xI(a:Array<Array<Int>>):Int{
        return sum_I(multiply_xI(a));
    }
    public function multisum_xF(a:Array<Array<Float>>):Float{
        return sum_F(multiply_xF(a));
    }
    
    
    public function sum_previous_I(a:Array<Int>):Array<Int>{
        return [for (i in 0...a.length) (i == 0) ? a[i] : a[i] + a[i - 1]];
    }
    public function diff_previous_I(a:Array<Int>):Array<Int>{
        return [for (i in 0...a.length) (i == 0) ? a[i] : a[i] - a[i - 1]];
    }
    public function sum_before_I(a:Array<Int>):Array<Int>{
        var rez:Array<Int> = [];
        var x:Int = 0;
        for (i in 0...a.length){
            x += a[i];
    ...
    public function diff_before_I(a:Array<Int>):Array<Int>{
    ...
    public function sum_previous_F(a:Array<Float>):Array<Float>{
        return [for (i in 0...a.length) (i == 0) ? a[i] : a[i] + a[i - 1]];
    }
    public function diff_previous_F(a:Array<Float>):Array<Float>{
        return [for (i in 0...a.length) (i == 0) ? a[i] : a[i] - a[i - 1]];
    }
    public function sum_before_F(a:Array<Float>):Array<Float>{
        var rez:Array<Float> = [];
        var x:Float = 0;
        for (i in 0...a.length){
            x += a[i];
    ...
    public function diff_before_F(a:Array<Float>):Array<Float>{
    ...
    public function recounter_I_F(what:Array<Int>):Array<Float>{
        var rez:Array<Float> = [];
        return [for (i in 0...what.length) rez.push(what[i])];
    }
    public function recounter_F_I(what:Array<Float>):Array<Int>{
        var rez:Array<Int> = [];
        return [for (i in 0...what.length) rez.push(Std.int(what[i]))];
    }
    public function recounter_I_S(what:Array<Int>):Array<String>{
        var rez:Array<String> = [];
        rez = [for (i in 0...what.length) Std.string(what[i])];
        return rez;
    }
    public function recounter_F_S(what:Array<Float>):Array<String>{
        var rez:Array<String> = [];
        rez = [for (i in 0...what.length) Std.string(what[i])];
        return rez;
    }
    public function recounter_S_I(what:Array<String>):Array<Int>{
        var rez:Array<Int> = [];
        rez = [for (i in 0...what.length) Std.parseInt(what[i])];
        return rez;
    }
    public function recounter_S_F(what:Array<String>):Array<Float>{
        var rez:Array<Float> = [];
        rez = [for (i in 0...what.length) Std.parseFloat(what[i])];
        return rez;
    }
    
    public function repeater_F_F(n:Int, what:Array<Float>, full:Bool = false):Array<Float>{
    ...
    public function repeater_I_I(n:Int, what:Array<Int>, full:Bool = false):Array<Int>{
    ...
    public function repeater_S_S(n:Int, what:Array<String>, full:Bool = false):Array<String>{
    ...
    public function an_in_b_S(a:Array<String>, b:Array<String>):Array<Array<Int>>{
    ...
    public function an_in_bn_S(a:Array<String>, b:Array<Array<String>>):Array<Array<Int>>{
        var rez:Array<Array<Int>> = null;
        for (ia in 0...a.length){
            for (ib in 0...b.length){
    ...
    public function an_in_b_I(a:Array<Int>, b:Array<Int>):Array<Array<Int>>{
        var rez:Array<Array<Int>> = null;
        for (ia in 0...a.length){
            for (ib in 0...b.length){
                if (a[ia] == b[ib]) { rez.push([ia, ib]); }
    ...
    public function an_in_bn_I(a:Array<Int>, b:Array<Array<Int>>):Array<Array<Int>>{
        var rez:Array<Array<Int>> = null;
        for (ia in 0...a.length){
            for (ib in 0...b.length){
                for (ibn in 0...b[ib].length){
    ...
    public function an_in_b_F(a:Array<Float>, b:Array<Float>):Array<Array<Int>>{
        var rez:Array<Array<Int>> = null;
        for (ia in 0...a.length){
            for (ib in 0...b.length){
                if (a[ia] == b[ib]) { rez.push([ia, ib]); }
    ...
    public function an_in_bn_F(a:Array<Float>, b:Array<Array<Float>>):Array<Array<Int>>{
        var rez:Array<Array<Int>> = null;
        for (ia in 0...a.length){
            for (ib in 0...b.length){
                for (ibn in 0...b[ib].length){
    ...
    public function chain_S(a:Array<String> ,n:Int ,ring:Bool = false):Array<Array<String>>{
    ...
    public function chain_I(a:Array<Int> ,n:Int ,ring:Bool = false):Array<Array<Int>>{
        var rez:Array<Array<Int>> = null;
        var a_l:Int = a.length;
        if (n > a_l || n < 1){ return rez; }
        var ind:Array<Array<Int>> = chain_indexes(a_l, n, ring);
    ...
    public function chain_F(a:Array<Float> ,n:Int ,ring:Bool = false):Array<Array<Float>>{
    ...
    public function steps_internal(xmin:Float, xmax:Float, n:Int, borders:Bool = false):Array<Float>{
        var rez:Array<Float> = null;
        if (n < 1){ return rez; }
    ...
    public function sin_cos_cut(x:Float):Float { return (x>1)?1:(x<-1)?-1:x; }
    public function degrees(angle:Float):Float { return angle * 180 / Math.PI; }
    public function radians(angle:Float):Float { return angle / 180 * Math.PI; }
    ...
    public function vecXDmod(vecXD:Array<Float>):Float{
        var sum:Float = 0;
        for (i in vecXD){sum += i*i;}
        return Math.sqrt(sum);
    }
    public function vecXDfieldmod(vecXDfield:Array<Array<Float>>):Array<Float>{
        var rez:Array<Float> = null;
        rez = [for (i in vecXDfield) vecXDmod(i)];
        return rez;
    }
    public function maxabs(vecXD:Array<Float>):Float{
        var rez:Float = 0;
        for (i in vecXD){if (Math.abs(i) > Math.abs(rez)){rez = i;}}
        return rez;
    }
    public function vecXD(dot3Da:Array<Float>, dot3Db:Array<Float>):Array<Float>{
        var rez:Array<Float> = null;
        if (
    ...
    public function vecXDsame(vecXDa:Array<Float>,vecXDb:Array<Float>):Bool{
    ...
    public function vecXDfieldsame(vecXDfield:Array<Array<Float>>):Bool{
    ...
    public function vecXDparalleled_sameside(vecXDa:Array<Float>, vecXDb:Array<Float>):Bool{
        var rez:Bool = null;
        if (vecXDa.length != vecXDb.length){ return rez; }
        return vecXDsame(vecXDone(vecXDa), vecXDone(vecXDb));
    }
    public function vecXDparalleled_opposite(vecXDa:Array<Float>, vecXDb:Array<Float>):Bool{
        var rez:Bool = null;
        if (vecXDa.length != vecXDb.length){ return rez; }
    ...
    public function vecXDscalar(vecXDa:Array<Float>, vecXDb:Array<Float>):Float{
        var rez:Float = null;
        if (vecXDa.length == vecXDb.length){
            rez = 0;
    ...
    public function vecXDcos(vecXDa:Array<Float>, vecXDb:Array<Float>):Float{
        var rez:Float = null;
    ...
    public function vecXDangle(vecXDa:Array<Float>, vecXDb:Array<Float>, rad:Bool = false):Float{
        var rez:Float = null;
        var la:Float = vecXDmod(vecXDa);
        var lb:Float = vecXDmod(vecXDb);
        if (la > 0 && lb > 0){
    ...
    public function vecXDsamesize(vecXDa:Array<Float>, vecXDb:Array<Float>):Bool{
        return vecXDa.length == vecXDb.length;
    }
    public function vecXDfieldsamesize(vecXDfield:Array<Array<Float>>):Bool{
    ...
    public function dot3D_to_dot2Dviewplane(dot3D:Array<Float>, dot3Dox:Array<Float>, dot3Doz:Array<Float>):Array<Float>{
        var rez:Array<Float> = null;
    ...
    public function distance_dot3D_plane3D(dot3D:Array<Float>, plane3D:Array<Float>):Float{
        var rez:Float = null;
    ...
    public function curve3Dbeziercubic(dot3D1:Array<Float>, vec3D1:Array<Float>, distance1:Float, dot3D2:Array<Float>, vec3D2:Array<Float>, distance2:Float):Array<Array<Float>>{
        var rez:Array<Array<Float>> = null;
        if (
    ...
    public function curve3Dbeziercubic_3dots(dot3D0:Array<Float>, dot3D1:Array<Float>, dot3D2:Array<Float>, lever1:Float = 0.55, lever2:Float = 0.55, a_s:Int = -1):Array<Array<Float>>{
        var rez:Array<Array<Float>> = null;
        if (
    ...
    public function line3Dbeziercubic_2dots(dot3D0:Array<Float>, dot3D1:Array<Float>):Array<Array<Float>>{
        var rez:Array<Array<Float>> = null;
        if (
    ...
    public function line3Dbeziercubic(dot3D:Array<Float>, vec3D:Array<Float>, distance:Float):Array<Array<Float>>{
        var rez:Array<Array<Float>> = null;
        if(
            distance == 0 ||
    ...
    public function beziercubic3D_4to12(curve:Array<Array<Float>>):Array<Float>{
        var rez:Array<Float> = null;
        if (
            curve.length == 4 &&
            curve[0].length == 3 &&
    ...
    public function beziercubic3D_12to4(curve:Array<Float>):Array<Array<Float>>{
        var rez:Array<Array<Float>> = null;
        if (curve.length == 12){
            rez = [for (i in [0,3,6,9]) [ for (ai in 0...3) curve[ai+i]]];
        }return rez;
    }
    public function beziercubic3D_derivativeparameters(curve:Array<Array<Float>>):Array<Array<Float>>{
        var rez:Array<Array<Float>> = null;
    ...
    public function beziercubic_derivative(bcp:Array<Float>, p:Float):Float{
        var rez:Float = null;
        if (bcp.length == 4){
    ...
    public function beziercubic_support_dot_one(beziercubic_one_axis_coordinates:Array<Float>):Float{
    ...
    public function beziercubic_support_dot_two(beziercubic_one_axis_coordinates:Array<Float>):Float{
        var c:Array<Float> = beziercubic_one_axis_coordinates;
        var rez:Float = null;
        if (c.length != 4){ return rez;}
    ...
    public function beziercubic3D_follow_4dots_trajectory(dots:Array<Array<Float>>):Array<Array<Float>>{
        var rez:Array<Array<Float>> = null;
    ...
    public function beziercubic_coordinate(beziercubic_one_axis_coordinates:Array<Float>, parameter:Float):Float{
        var rez:Float = null;
        var c:Array<Float> = beziercubic_one_axis_coordinates;
    ...
    public function curve3D_4dots_follow_beziercubic_trajectory(beziercubic3D:Array<Array<Float>>):Array<Array<Float>>{
        var rez:Array<Array<Float>> = null;
        var c:Array<Array<Float>> = beziercubic3D;
        if (c.length != 4 || !vecXDfieldsamesize(c)){ return rez; }
    ...
    //ellipse section
    public function ellipse2Dperimeter_ramanujan(
        semiaxis_a:Float,
        semiaxis_b:Float
    ):Float{
        var rez:Float = null;
    ...
    public function ellipse_e_parameter(
        semiaxis_a:Float,
        semiaxis_b:Float
    ):Float{
        var rez:Float = null;
    ...
    public function ellipse2Ddot(angle:Float, semiaxis_a_ox:Float, semiaxis_b_oy:Float, rad:Bool = false):Array<Float>{
        var u:Float = angle;
    ...
    public function angle_vec3Dvec3D_projection_on_plane3D(vec3D1:Array<Float>, vec3D2:Array<Float>, plane3D:Array<Float>, rad:Bool = false):Float{
        var rez:Float = null;
