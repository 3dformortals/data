...
class GeometryXD:
    ...
    @staticmethod
    def dot3Dline_x_plane(dot3D0,vec3D0,vec3Dplane,dplane = 0):
        if (dplane is None):
            dplane = 0
        rez = None
        ldot = len(dot3D0)
    ...
    @staticmethod
    def dot3Dprojection_on_plane(dot3D,plane3D):
        rez = None
        ldot = len(dot3D)
        lplane = len(plane3D)
    ...
    @staticmethod
    def plane3D_dot_normal(dot3D,vec3D):
        rez = None
        if (GeometryXD.vecXDmod(vec3D) == 0):
            return rez
    ...
    def plane3D_dot_vec_vec(dot3D,vec3Da,vec3Db):
        ...
        if ((GeometryXD.vecXDsame(vec3Da,vec3Db) or ((GeometryXD.vecXDmod(vec3Da) == 0))) or ((GeometryXD.vecXDmod(vec3Db) == 0))):
            return rez
        rez = GeometryXD.plane3D_dot_normal(dot3D,GeometryXD.vec3Dnormal(vec3Da,vec3Db))
        return rez
    ...
    def plane3D_2dots(dot3D,dot3Da):
        ...
        if ((not GeometryXD.vecXDsamesize(dot3D,dot3Da)) or GeometryXD.vecXDsame(dot3D,dot3Da)):
            return rez
        rez = GeometryXD.plane3D_dot_normal(dot3D,GeometryXD.vecXD(dot3D,dot3Da))
        return rez

    @staticmethod
    def distance3D_dot_plane(dot3D,plane3D):
        rez = None
    ...
    @staticmethod
    def random3D_vec_in_plane(plane3D):
        rez = None
        if (GeometryXD.vecXDmod(plane3D[0:3]) == 0):
            return rez
        t0 = GeometryXD.vecXDrandom(3)
        t0 = GeometryXD.dot3Dprojection_on_plane(t0,plane3D)
        t1 = t0
        while GeometryXD.vecXDsame(t0,t1):
            ...
            while (_g < 3):
                ...
                t1.append(x)
            t1 = GeometryXD.dot3Dprojection_on_plane(t1,plane3D)
        rez = GeometryXD.vecXD(t0,t1)
        return rez

    @staticmethod
    def random3D_dot_in_plane(plane3D,dot3D,radius):
        rez = None
        ...
        if (radius == 0):
            return rez
        vec3D = GeometryXD.random3D_vec_in_plane(plane3D)
    ...
    @staticmethod
    def arc3Dbeziercubic_3dots(dot3D0,dot3D1,dot3D2,lever1 = 0.55,lever2 = 0.55,a_s = -1):
        if (lever1 is None):
            lever1 = 0.55
        if (lever2 is None):
            lever2 = 0.55
    ...
    @staticmethod
    def beziercubic3D_12coordinates(curve):
        rez = None
    ...
    @staticmethod
    def vec3Dprojection_on_plane(vec3D,plane3D):
        rez = None
