...
class GeometryXD{
    ...
    **/
    ...
    /**
      returns true if incoming Int Array have at least one positive element
    ...
    **/
    ...
    /**
      returns true if incoming Int Array have at least one zero element
      @param a - incoming array
      @return Bool
    **/
    ...
    /**
      returns true if incoming Int Array have at least one negative element
      @param a - incoming array
      @return Bool
    **/
    ...
    /**
      returns true if incoming Float Array have at least one positive element
      @param a - incoming array
      @return Bool
    **/
    ...
    /**
      returns true if incoming Float Array have at least one zero element
      @param a - incoming array
      @return Bool
    **/
    ...
    /**
      returns true if incoming Float Array have at least one negative element
      @param a - 
      @return Bool
    **/
    ...
    /**
      returns true if Int Arrays have same size
    ...
    **/
    ...
    /**
      returns true if Float Arrays have same size
      @param a - incoming arrays
      @return Null<Bool>
    **/
    ...
    /**
      returns sum of Int Array elements
      @param a - incoming array
      @return Null<Int>
    **/
    ...
    /**
      returns sum of Float Array elements
      @param a - incoming array
      @return Null<Float>
    **/
    ...
    /**
      returns diff between first and others Int Array elements
      @param a - incoming array
      @return Null<Int>
    **/
    ...
    /**
      returns diff between first and others Float Array elements
      @param a - incoming array
      @return Null<Float>
    **/
    ...
    **/
    ...
    /**
      returns Int Array which is Int Arrays sum. [[1, 2, 3], [-3, -2, -1]] return [-2, 0, 2]
      @param a - incoming arrays
      @return Array<Int>
    **/
    ...
    /**
      returns Float Array which is Float Arrays sum. [[1.1, 2, 3], [-3, -2, -1]] return [-1.9, 0, 2]
      @param a - incoming arrays
      @return Array<Float>
    **/
    ...
    /**
      returns Int Array which is result of diff between first Int Array and others. [[1, 2, 3], [-3, -2, -1]] return [4, 4, 4]
      @param a - incoming arrays
      @return Array<Int>
    **/
    ...
    /**
      returns Float Array which is result of diff between first Float Array and others. [[1.1, 2, 3], [-3, -2, -1]] return [4.1, 4, 4]
      @param a - incoming arrays
      @return Array<Float>
    **/
    ...
    /**
      returns Float Array with middle values from arrays. [[1.1, 2, 3], [-3, -2, -1]] return [(1.1 - 3) / 2, (2 - 2) / 2, (3 - 1) / 2]
      @param a - incoming arrays
      @return Array<Float>
    **/
    ...
    /**
      returns Int arrays which is result of multiplying each element by Int
      @param a - incoming arrays
      @param n - multiplier
    ...
    **/
    ...
    /**
      returns Float arrays which is result of multiplying each element by Float
      @param a - incoming arrays
      @param n - multiplier
    ...
    **/
    ...
    /**
      returns Int Array which is result of multiplying arrays. [[1, 2], [3, 4]] return [1 * 3, 2 * 4]
      @param a - incoming arrays
      @return Array<Int>
    **/
    ...
    /**
      returns Float Array which is result of multiplying arrays. [[3.1, 2], [3, 4]] return [3.1 * 3, 2 * 4]
      @param a - incoming arrays
      @return Array<Float>
    **/
    ...
    **/
    ...
    /**
      returns Int Array which is result of sum with previous element. [1, 2, 3] return [1, 3, 5]
      @param a - incoming array
      @return Array<Int>
    **/
    ...
    /**
      returns Int Array which is result of diff with previous element. [1, 2, 3] return [1, 1, 1]
      @param a - incoming array
      @return Array<Int>
    **/
    ...
    /**
      returns Int Array which is result of sum each element with before elements sum. [1, 2, 3] return [1, 3, 6]
      @param a - incoming array
      @return Array<Int>
    **/
    ...
    /**
      returns Int Array which is result of diff each element with before elements diff. [1, 2, 3] return [1, 1, 2]
      @param a - incoming array
      @return Array<Int>
    **/
    ...
    /**
      returns Float Array which is result of sum with previous element. [1.1, 2, 3] return [1.1, 3.1, 5]
      @param a - incoming array
      @return Array<Float>
    **/
    ...
    /**
      returns Float Array which is result of diff with previous element. [1.1, 2, 3] return [1.1, 0.9, 1]
      @param a - incoming array
      @return Array<Float>
    **/
    ...
    /**
      returns Float Array which is result of sum each element with before elements sum. [1.1, 2, 3] return [1.1, 3.1, 6.1]
      @param a - incoming array
      @return Array<Float>
    **/
    ...
    /**
      returns Float Array which is result of diff each element with before elements diff. [1.1, 2, 3] return [1.1, 0.9, 2.1]
      @param a - incoming array
      @return Array<Float>
    **/
    ...
    **/
    public static function dot3D_to_dot2Dviewplane(dot3D:Array<Float>, dot3Dox:Array<Float>, dot3Doz:Array<Float>):Array<Float>{
        ...
        var cosox0t:Float = multisum_xF([dot3Dox,dot3D]) / (t + vecXDnorm(dot3Dox));
        var cosoz0t:Float = multisum_xF([dot3Doz,dot3D]) / (t + vecXDnorm(dot3Doz));
        // var cosox0t:Float = (
        //     dot3Dox[0] * dot3D[0] +
        //     dot3Dox[1] * dot3D[1] +
        //     dot3Dox[2] * dot3D[2]
    ...
    /**
     returns a point with scaled values relative to the scaling center
     @param dotXD - 
     @param scaleXD - 
     @param dotXDc - 
     @return Array<Float>
